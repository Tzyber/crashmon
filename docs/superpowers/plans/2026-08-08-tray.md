...
**Interfaces:**
- Produces: `pub fn pdeathsig_pre_exec(expected_ppid: u32) -> impl FnMut() -> io::Result<()> + Send + Sync + 'static` (für `pre_exec` — `pre_exec` verlangt die Result-Rückgabe und Sync)
